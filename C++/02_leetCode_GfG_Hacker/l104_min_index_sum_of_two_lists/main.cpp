...
int main(int argc, char* argv[])
{
  ...
  // vector<std::string> list1 {"Shogun","Tapioca Express","Burger King","KFC"}, list2 {"Piatti","The Grill at Torrey Pines","Hungry Hunter Steakhouse","Shogun"};
