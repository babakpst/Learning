...
int main(int argc, char* argv[])
{
  ...
  Logger logger;
  cout <<  boolalpha<< logger.shouldPrintMessage(1, "foo")<< endl;  // return true, next allowed timestamp for "foo" is 1 + 10 = 11
  cout <<  boolalpha<< logger.shouldPrintMessage(2, "bar")<< endl;  // return true, next allowed timestamp for "bar" is 2 + 10 = 12
  ...
  cout <<  boolalpha<< logger.shouldPrintMessage(11, "foo")<< endl; // 11 >= 11, return true, next allowed timestamp for "foo" is 11 + 10 = 21
