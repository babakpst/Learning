...
void computeIteration(const unsigned char* const dstImg,
                      ...
                      const std::vector<uint2>& interiorPixelList, const size_t numColsSource,
                      const float* const f, const float* const g, float* const f_next)
{
...
void computeG(const unsigned char* const channel, float* const g, const size_t numColsSource,
...
void reference_calc(const uchar4* const h_sourceImg, const size_t numRowsSource,
                    const size_t numColsSource, const uchar4* const h_destImg,
                    uchar4* const h_blendedImg)
{
  ...
  {
    computeIteration(red_dst, strictInteriorPixels, borderPixels, interiorPixelList, numColsSource,
  ...
  for (size_t i = 0; i < numIterations; ++i)
  {
    computeIteration(blue_dst, strictInteriorPixels, borderPixels, interiorPixelList, numColsSource,
  ...
  for (size_t i = 0; i < numIterations; ++i)
  {
    computeIteration(green_dst, strictInteriorPixels, borderPixels, interiorPixelList,
                     numColsSource, blendedValsGreen_1, g_green, blendedValsGreen_2);
