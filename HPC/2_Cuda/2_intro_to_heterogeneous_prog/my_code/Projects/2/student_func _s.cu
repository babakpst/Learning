	...
	const int filterWidth)
{
	...
	gaussian_blur_noshared << <gridSize, blockSize >> > (d_red, d_redBlurred, numRows, numCols, d_filter, filterWidth);
	gaussian_blur_noshared << <gridSize, blockSize >> > (d_green, d_greenBlurred, numRows, numCols, d_filter, filterWidth);
	gaussian_blur_noshared << <gridSize, blockSize >> > (d_blue, d_blueBlurred, numRows, numCols, d_filter, filterWidth);
	/*
