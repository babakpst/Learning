...
int main()
{
  ...
  initWith<<<numberOfBlocks, threadsPerBlock, 0, stream1>>>(3, d_a, N);
  initWith<<<numberOfBlocks, threadsPerBlock, 0, stream2>>>(4, d_b, N);
  initWith<<<numberOfBlocks, threadsPerBlock, 0, stream3>>>(0, d_c, N);
