...
// sudo nvprof --metrics gst_efficiency,gld_efficiency ./bin/reduce



// benchmark kernel: gives the max efficiency we get for transpose operation
// read/write are both coalesced.
...
// benchmark kernel: lower bound of the memory performance. 
// read/write are both non coalesced.
...
// read coalesced, but write not coalesced
...
// read not coalesced, but write coalesced
