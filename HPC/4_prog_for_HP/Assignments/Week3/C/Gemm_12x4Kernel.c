		...
		double *C, int ldC )
{
  ...
  __m256d gamma_4567_0 = _mm256_loadu_pd( &gamma( 0+4,0 ) );
  __m256d gamma_4567_1 = _mm256_loadu_pd( &gamma( 0+4,1 ) );
  __m256d gamma_4567_2 = _mm256_loadu_pd( &gamma( 0+4,2 ) );
  __m256d gamma_4567_3 = _mm256_loadu_pd( &gamma( 0+4,3 ) );

  __m256d gamma_891011_0 = _mm256_loadu_pd( &gamma( 0+8,0 ) );
  __m256d gamma_891011_1 = _mm256_loadu_pd( &gamma( 0+8,1 ) );
  __m256d gamma_891011_2 = _mm256_loadu_pd( &gamma( 0+8,2 ) );
  __m256d gamma_891011_3 = _mm256_loadu_pd( &gamma( 0+8,3 ) );
