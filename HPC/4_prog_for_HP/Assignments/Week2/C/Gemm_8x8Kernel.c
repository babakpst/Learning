		...
		double *C, int ldC )
{
  ...
  __m256d gamma_4567_4 = _mm256_loadu_pd( &gamma( 0+4,4 ) );
  __m256d gamma_4567_5 = _mm256_loadu_pd( &gamma( 0+4,5 ) );
  __m256d gamma_4567_6 = _mm256_loadu_pd( &gamma( 0+4,6 ) );
  __m256d gamma_4567_7 = _mm256_loadu_pd( &gamma( 0+4,7 ) );
